...
func NewSessionProvider(sCfg config.SessionConfig, authRepo *repository.AuthRepository) TokenProvider {
...
func (p *SessionProvider) ValidateToken(ctx context.Context, token string) (*Actor, error) {
